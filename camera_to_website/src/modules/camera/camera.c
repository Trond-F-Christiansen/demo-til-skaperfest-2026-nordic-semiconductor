...
LOG_MODULE_REGISTER(camera, CONFIG_LTE_CAMERA_CAMERA_LOG_LEVEL);

ZBUS_SUBSCRIBER_DEFINE(camera, CONFIG_LTE_CAMERA_CAMERA_MESSAGE_QUEUE_SIZE);

#define CAM_WIDTH  CONFIG_LTE_CAMERA_CAMERA_WIDTH
#define CAM_HEIGHT CONFIG_LTE_CAMERA_CAMERA_HEIGHT
...
K_THREAD_DEFINE(camera_task_id,
		CONFIG_LTE_CAMERA_CAMERA_THREAD_STACK_SIZE,
